...
//                            $idCate=$valueCate["Category"]["Id"];
        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <h2 class="bold">THÔNG TIN LIÊN HỆ</h2><br/>
                <span class="bold">Công ty Thiết Bị Số</span><br/>
                <span>Địa chỉ: Phường - Quận - Thành Phố</span><br/>
                <span>Điện thoại: 0123456789</span><br/>
                <span>Email: <a href="mailto:thietbiso@gmail.com">thietbiso@gmail.com</a></span><br/>
                <span>Facebook: <a href="https://www.facebook.com/pages/Thi%E1%BA%BFt-b%E1%BB%8B-s%E1%BB%91/852071751497173?ref=hl">Thiết Bị Số</a></span><br/>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3723.856276141077!2d105.77415599999999!3d21.038436!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b628748045%3A0xf180050945d02164!2zVHLGsOG7nW5nIELhu5NpIGTGsOG7oW5nIEPDoW4gYuG7mSBRdeG6o24gbMO9IFbEg24gaG_DoSBUaOG7gyB0aGFvIHbDoCBEdSBs4buLY2g!5e0!3m2!1svi!2s!4v1433485138941" width="100%" height="250px" frameborder="0" style="border:0"></iframe>
            </div>

            <hr/>
            <h2 class="bold">THÔNG TIN PHẢN HỒI</h2><BR/>
            <span>Xin vui lòng điền các yêu cầu vào form dưới đây và gửi cho chúng tôi.
                Chúng tôi sẽ trả lời bạn ngay sau khi nhận được.
                Xin chân thành cảm ơn!</span><br/>
                <?php // echo $this->Form->input("hoten"); ?>
                <form class="form-horizontal" role="form" method="post" id="form-contact">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-success" title="gui" name="lienhe">Gửi</button>
                    </div>
                </div>
            </form>
