            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width: 50px;" name="quantity[<?php echo $id; ?>]"  value="<?php echo $value["quantity"]?>" /><br/>
                            <input type="submit" class="pointer" value="Cập nhật" /> - <a class="pointer" href="?del=<?php echo $value['id'] ?>">Xóa</a>
                        </td>
                    ...
                    <?php } ?>
                    <tr>
                        <td colspan="5">Tổng tiền đơn hàng(<i>Đã bao gồm VAT</i>): <?php echo $total; ?></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
                <button class="btn btn-success" type="submit" name="order" style="border-radius: 0px !important;">
