                ...
                <div id="filter" class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
                    <div class="panel list-group">
                        ...
                        <div id="price" class="sublinks collapse">
                            ...
                            <?php echo $this->html->link($this->html->tag('span','',array('class'=>'glyphicon glyphicon-chevron-right')).'15 triệu -> 20 triệu',array('controller'=>'sanpham','action'=>'sanpham?min=1500000 & max=20000000'),array('class'=>'list-group-item small','escape'=>false)); ?>
...
//                    var_dump($dataProduct); exit;
                foreach ($dataFilter as $valueProduct) {
//                    echo "<pre>";
