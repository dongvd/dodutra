...
//                            $idCate=$valueCate["Category"]["Id"];
        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
            ...
            <div class="row">
                <?php
                foreach ($dataSearch as $valueSearch) {
                    $imgProduct="sanpham/small/".$valueSearch["products"]["Image"];
                ?>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 border " >
                                ...
                                <span>Tên: <a><?php echo $valueSearch["products"]["ProductName"];?></a></span><br/>
                                <span>Giá:<span style="color: red;"><?php echo number_format($valueSearch["products"]["Price"])."đ";?></span></span><br/>
                                <center><a  class="btn btn-success btn-sm" href="?cart=<?php echo $valueSearch["products"]["id"];?>">Thêm vào giỏ hàng</a></center>
                            </div>
                <?php
                    }
                ?>                
